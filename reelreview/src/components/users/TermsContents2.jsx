...
export default function TermsContens2({ setTermsCt2State }) {
    ...
    const clickOutsideHandler = (e) => {
        const modal = document.querySelector(`.${styles.user_terms_modal_3}`);
        if (modal && !modal.contains(e.target)) { setTermsCt2State(false); }
    };



    return (
        <div className={styles.user_terms_modal_3}>
            ...
            <div className={styles.user_terms_contents}>
                ...
                주식회사 릴리뷰는(이하 ‘회사’라고 합니다)는 릴리뷰(REEL REVIEW) 및 릴리뷰 관련 제반 서비스(이하 “서비스”라고 합니다)를 이용하는 회원의 개인정보 보호를 소중하게 생각하고, 회원의 개인정보를 보호하기 위하여 항상 최선을 다해 노력하고 있습니다.
                ...
                7) 릴리뷰파티 이용 시 생성된 대화 내역은 서비스 개선을 위한 통계의 목적으로 수집할 수 있습니다.
                ...
                1항. 회사는 회원의 개인정보를 본 개인정보처리방침에서 명시된 범위를 초과하여 이용하거나 회원의 동의 없이 본 개인정보처리방침에 명시된 제공 대상자 외의 제3자(타인 또는 타기 업 기관)에 제공하지 않습니다. 다만, 다음 각호의 어느 하나에 해당하는 경우에는 예외로 합니다.
                ...
                - 수탁업체: 주식회사 릴리뷰(주식회사 릴리뷰 자회사)
                - 위탁 업무: 릴리뷰 고객센터 운영 업무를 목적으로 청약 철회, 해지 예약, 탈퇴 진행 및 분실된 계정 조회 등 고객의 민원 처리
                ...
                3항. 릴리뷰파티 이용 시 생성된 대화 내역은 서비스 품질 개선의 목적으로 1년간 보관되며, 그 후 즉시 파기됩니다.

                4항. 회원의 개인정보는 개인정보의 수집 및 이용목적이 달성되면 지체 없이 파기되나, 아래 각 항목에 해당하는 경우에는 명시한 기간 동안 보관할 수 있으며, 그 외 다른 목적으로는 사용하지 않습니다.
                ...
                성 명: 홍길동
                소 속: 개인정보보호팀
                전자우편: hong@reelreview.com
                [개인정보관리담당자]
                성 명: 고길동
                소 속: 개인정보보호팀
                전자우편: ko@reelreview.com
                ...
                - 전화번호: 031-123-456
                - 팩스번호: 031-123-456
                - 전자우편: cs@reelreview.co.kr
                - 웹문의: https://help.reelreview.co.kr/hc/ko/requests/new
                - 주소: 경기도 수원시 팔달구 매산로 12-1 릴리뷰 고객센터 (우 16461)
                ...
                [어린이를 위한 개인정보처리방침]
                릴리뷰에서 제공하는 서비스(릴리뷰)에 가입하시는 회원님들에게 개인정보의 수집과 이용 목적, 개인정보 보관과 이용 기간에 대해 알려드려요.
